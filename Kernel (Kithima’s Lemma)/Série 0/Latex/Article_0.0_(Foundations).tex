...
The foundational series (Articles 0.0–0.12) is organised as follows (updated to reflect new numbering and the integration of the Barnette series and prime families):
...
\midrule
0.0 & Foundations of the Spectral Reduction Lemma & This article: introduction, four pillars, four core strategies, advanced strategies (SRP, SUTL, SHS), list of 33 resolved problems. \\
...
0.8 & Other Spectral Strategies & FM, SRP, DUST, SFF, Hilbert–Pólya, Backward Transfer, CTP, SUTL, SHS – conditions and obstacles. \\
...
\begin{itemize}
\item \textbf{SRP (Spectrum of the Rational Points)}: Proves the Birch–Swinnerton-Dyer conjecture (Series XXX).
...
\section{The thirty‑three resolved problems (new order)}

The following table lists all **thirty‑three** problems resolved by the spectral reduction lemma, with their series numbers (I–XXXIII) and the strategy used. The order reflects logical dependencies and historical significance.
