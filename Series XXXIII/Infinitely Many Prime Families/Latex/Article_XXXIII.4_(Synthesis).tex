...
\title{Series XXXIII – Article XXXIII.4: Synthesis – Infinitude of Several Prime Families (Revised – 33 Problems)}
...
\item \textbf{P4 (Deterministic extraction)}: D‑RSP algorithm extracts a prime pair in polynomial time.
\end{enumerate}
...
33 & \textbf{Infinitude of prime families (XXXIII)} & \textbf{FV} \\
\bottomrule
\end{longtable}
\end{center}
