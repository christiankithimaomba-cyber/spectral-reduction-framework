...
/-- Brandão–Horodecki theorem: exponential decay of correlations implies area law.
    Reference: Brandão, F. G. S. L., & Horodecki, M. (2013).
    Exponential decay of correlations implies area law. Commun. Math. Phys. 333(2), 761–798. -/
