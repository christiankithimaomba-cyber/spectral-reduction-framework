...
/-- Hilbert curve ordering: linear order with low edge boundary for any bounded‑degree graph.
    Reference: Hilbert, D. (1891). Über die stetige Abbildung einer Linie auf ein Flächenstück.
