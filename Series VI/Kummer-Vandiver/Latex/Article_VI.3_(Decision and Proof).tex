...
\title{Series VI – Article VI.3: Decision and Proof}
...
\item Form $H_p = T_p - I$.
\item Use the functional D‑RSP algorithm (which is simply a variant of the power iteration on this finite matrix) to compute the smallest eigenvalue $\lambda_{\min}(H_p)$.
