/-
BarnetteGap.lean – Spectral gap via Cheeger and Kithima Bridge.
...
/-- For cubic planar bipartite graphs, the Cheeger constant is bounded below by a positive constant. -/
...
/-- Spectral gap of the transfer operator T_G is uniformly bounded below. -/
axiom spectral_gap_T_pos (G : SimpleGraph V) [Fintype V] [DecidableEq V] (hG : barnette_graph G) :
    ∃ γ > 0, ∀ λ ∈ spectrum (T_G G hG), λ ≠ 1 → |1 - λ| ≥ γ
